    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewBooks.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(BookManagementActivity.this, com.allcodingtutorials.sqliteapplication.UpdateBookActivity.class);
        ...
        addBookButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BookManagementActivity.this, com.allcodingtutorials.sqliteapplication.AddBookActivity.class);
                startActivity(intent);
            }
        });
    }
